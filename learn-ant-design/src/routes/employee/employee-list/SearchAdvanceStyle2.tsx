...
const SearchAdvanceStyle2 = () => {
    ...
    const handleSearchAdvanceButton = () => {
    ...
    return (
        <>
            <Modal
                ...
                width={showAdvance ? '45vw' : '60vw'}
                style={{ top: 50, left: showAdvance ? '-25vw' : '', minHeight: '50vh' }}
            >
                <EmployeeNormalSearchForm />
                <Space style={{ display: 'flex', justifyContent: 'flex-end' }}>
                    <a style={{ fontSize: 12 }} onClick={() => handleSearchAdvanceButton()}>
                ...
                <Modal
                    ...
                    width={showAdvance ? '45vw' : '60vw'}
                    style={{ top: 50, right: showAdvance ? '-25vw' : '', minHeight: '50vh' }}
                >
            ...
            <Button onClick={() => setShowListModal(true)}>Search Advance Style 2</Button>
        </>
    );
};

export default SearchAdvanceStyle2;